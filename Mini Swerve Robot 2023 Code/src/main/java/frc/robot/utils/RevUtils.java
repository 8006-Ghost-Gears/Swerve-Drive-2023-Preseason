...
public final class RevUtils {
  ...
  public static void setTurnMotorConfig(CANSparkMax motorController) {
    ...
    motorController.setSmartCurrentLimit(25, 15);
  ...
  public static void setDriveMotorConfig(CANSparkMax motorController) {
    motorController.getPIDController().setFF(.2, PID_SLOT.VEL_SLOT.ordinal());//0.075  if you want to go fast set to 0.215 Will drain battery if current limits too high
    motorController.getPIDController().setP(0.215, PID_SLOT.VEL_SLOT.ordinal());//0.075 if you want to go fast set to 0.2 Will drain battery if current limits too high
    ...
    motorController.setSmartCurrentLimit(30, 25);
